...
public class FURenderer implements OnFaceUnityControlListener {
     ...
     * @param frameRotation
     */
    public void onDeviceOrientationChanged(final int deviceOrientation, final int frameRotation) {
        if (mDeviceOrientation == deviceOrientation && mInputImageOrientation == frameRotation) {
            return;
        }
